...
<MobileElementEntity>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'My Cart' or . = 'My Cart') and @resource-id = 'com.saucelabs.mydemoapp.android:id/productTV']</locator>
