...
<MobileElementEntity>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Sauce Lab Back Packs' or . = 'Sauce Lab Back Packs') and @resource-id = 'com.saucelabs.mydemoapp.android:id/titleTV']</locator>
