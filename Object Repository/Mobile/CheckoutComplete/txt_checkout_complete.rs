...
<MobileElementEntity>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Checkout Complete' or . = 'Checkout Complete') and @resource-id = 'com.saucelabs.mydemoapp.android:id/completeTV']</locator>
